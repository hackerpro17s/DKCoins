...
public class DKCoinsBankAdminCommandOld extends BasicCommand implements Completable {

    private final List<String> ACTIONS = Arrays.asList("set", "add", "remove", "reset");

    public DKCoinsBankAdminCommandOld(ObjectOwner owner) {
